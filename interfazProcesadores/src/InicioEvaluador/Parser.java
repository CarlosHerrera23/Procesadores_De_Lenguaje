    ...
    */
    ...
    private void report(int pos, int found, int expecting) throws Exception {  
        ...
        if (found == Symbol.BAD_CHAR) {
            ...
            message = "No Valido " + Symbol.keys[n].spelling ;
        }
